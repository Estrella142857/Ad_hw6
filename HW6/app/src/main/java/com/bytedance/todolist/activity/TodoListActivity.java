...
public class TodoListActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE_CREATE_ITEM = 10000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TodoListActivity.this, TodoInput.class);
    ...
    private TodoListAdapter.OnItemClickListener TodoListClickListener = new TodoListAdapter.OnItemClickListener() {
        @Override
            ...
            if (RESULT_OK == resultCode && null != data) {
                new Thread(){
                    ...
                    public void run() {
                        ...
                        Snackbar.make(mFab, "Insert success", Snackbar.LENGTH_SHORT).show();
                        loadFromDatabase();
                    }
                }.start();
            }
